...
export class AskquestionComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.isQuestionset) {
      console.log("sending....");
      this.questionservice.addQuestion(1, this.AskQuestionForm.value.question, 0, this.AskQuestionForm.value.description, this.data.indexOf(this.AskQuestionForm.value.Tags) + 1, 321,this.fileToUpload).subscribe();
    }
  }
  ngOnInit() {
